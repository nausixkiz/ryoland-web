                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="ltn__tab-menu-list mb-50">
                                        <div class="nav">
                                            <a class="active show" data-bs-toggle="tab" id="tab-dashboard" href="#ltn_tab_1_1">Dashboard <i class="fas fa-home"></i></a>
                                            @if (Laravel\Fortify\Features::canUpdateProfileInformation())
                                                <a data-bs-toggle="tab" id="tab-profile" href="#ltn_tab_1_2">Profile Information <i class="fas fa-user"></i></a>
                                            @endif
                                            <a data-bs-toggle="tab" id="tab-address" href="#ltn_tab_1_3">address <i class="fas fa-map-marker-alt"></i></a>

                                            <a data-bs-toggle="tab" id="tab-properties" href="#ltn_tab_1_5">My Properties <i class="fa-solid fa-list"></i></a>
                                            <a data-bs-toggle="tab" id="tab-wishlist" href="#ltn_tab_1_6">Favorite Properties <i class="fa-solid fa-heart"></i></a>
                                            <a data-bs-toggle="tab" id="tab-add_property" href="#ltn_tab_1_7">Add Property <i class="fa-solid fa-map-location-dot"></i></a>
                                            <a data-bs-toggle="tab" id="tab-payment" href="#ltn_tab_1_8">Payments <i class="fa-solid fa-money-check-dollar"></i></a>
                                            @if (Laravel\Fortify\Features::enabled(Laravel\Fortify\Features::updatePasswords()))
                                            <a data-bs-toggle="tab" href="tab-change-password">Change Password <i class="fa-solid fa-lock"></i></a>
                                            @endif
                                            <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                document.getElementById('logout-form').submit();">Logout
                                                <em class="fa-solid fa-arrow-right-from-bracket"></em>
                                            </a>
                                                <form method="POST" id="logout-nav" action="{{ route('logout') }}">
                                                    @csrf
                                                </form>
                                        </div>
                                    </div>
